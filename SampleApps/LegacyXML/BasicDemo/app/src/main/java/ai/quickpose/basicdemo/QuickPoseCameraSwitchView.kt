...
import ai.quickpose.core.QuickPoseCameraView
...
constructor(context: Context,
            private var quickPose: QuickPose, attrs: AttributeSet? = null, defStyleAttr: Int = 0, ) :
    ...
    suspend fun startCamera(useFrontCamera: Boolean) {
        if (useFrontCamera) {
            backCameraView?.stop()
